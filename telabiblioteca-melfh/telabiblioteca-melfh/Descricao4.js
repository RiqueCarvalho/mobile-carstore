  ...
  return (
        <View style={Estilos.container}>
          ...
          <View style={Estilos.containerbody}>
            ...
            <Text style={Estilos.textHonda}>Dodge Charger 1970</Text>
            <Text style={Estilos.textDesc}>
            O Dodge Charger de 1970 é um dos modelos mais icônicos e adorados da história
            dos carros americanos. Faz parte da segunda geração do Dodge Charger, que foi
            produzida de 1968 a 1970. O Charger de 1970 é conhecido por seu design
            muscular, potência e presença nas ruas.
            </Text>
